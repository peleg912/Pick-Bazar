...
const checkoutBtn = (props)=> {
    return(
        <button className="hmkNrQ" onClick={props.clicked}>
            <span className="gvXQzQ">
             <span>
           ...
           <span className="cBPaQb">{props.products.length} Item</span>
           <span className="breCqf">${props.totalPrice}</span>
        </button>
    )
}
