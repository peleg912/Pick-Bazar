    ...
    return(
        ...
        <div className="empty-cart-container">
            ...
            <div className="empty-cart">
                <div className="empty" style={{left: '0px', right: 'auto'}}></div>
            </div>

         <div className="empty-cart-wrapper" style={{height: 'calc(100% + 1px)', float: 'left'}}>
          <div className="empty-cart-a"></div>
        </div>

              <div className="empty-cart-b" style={{margin: '0px', width: '419px', height: '182p'}}></div>
              
                 <div className="empty-cart-c">
                     <div className="empty-cart-d" style={{overflowY: 'scroll'}}>
                      <div className="empty-cart-e" style={{padding: '0px', height: '100%', width: '100%'}}>
                       <div className="empty-cart-img-wrapper">
                        ...
                        <span className="empty-cart-title">{translation[props.lang].cart.noProducts}</span>
                       ...
                       <div className="empty-cart-f">
                         <div className="empty-cart-g">
                           <div className="empty-cart-h" style={{width: '100%', transform: 'translate(0px, 0px)'}}>  </div>
                        </div>
                      </div>

                        <div className="empty-cart-i">
                          <div className="empty-cart-j">
                           <div className="empty-cart-k" style={{height: '52.4355%', transform: 'translate(0px, 0px)'}}> </div>
                         </div>
                        </div>

              <div className="empty-cart-l"></div>
