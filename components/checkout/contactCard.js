...
const contactCard = (props)=> {
    ...
    return(
        ...
        <input  type="radio"/>
         ...
         <span className="radio-card-content">{props.num}</span>
         ...
         <span className="edit-btn-group">
           ...
           <span className="delete-btn b" onClick={()=>props.onRemovingContactCard(props.id)}>
...
const mapDispatchToProps=(dispatch)=> {
  return{
      onRemovingContactCard: (cardId)=> dispatch({type:'REMOVE_CONTACT_CARD', id: cardId})
  }
};
