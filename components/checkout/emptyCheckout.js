...
const emptyCheckout = (props)=> {
    return(
        <div className="ebDXNG">

        <div className="coRYQB">
        ...
        <h3 className="enCIgv">{translation[props.lang].cart.noProducts}</h3>
...
export default connect(mapStateToProps)(emptyCheckout);